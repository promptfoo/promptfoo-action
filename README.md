...
| `env-files` | Comma-separated application `.env` paths loaded in order from and restricted to `working-directory`. Later files override earlier files; traversal, escaping symlinks, process-control, credential-routing, and Promptfoo authentication variables are rejected. | No |
