;(() => {
  var e = {
    ...
    599: (e, r, n) => {
      ...
      function cloneCallSite(e) {
        ...
        Object.getOwnPropertyNames(Object.getPrototypeOf(e)).forEach((n) => {
          r[n] = /^(?:is|get)/.test(n) ? () => e[n].call(e) : e[n]
        })
      ...
      function wrapCallSite(e, r) {
        ...
        if (n) {
          ...
          e.getFileName = () => u.source
          e.getLineNumber = () => u.line
          e.getColumnNumber = () => u.column + 1
          e.getScriptNameOrSourceURL = () => u.source
          return e
        }
    ...
    684: (e, r, n) => {
      ...
      SourceMapConsumer.fromSourceMap = (e, r) =>
        BasicSourceMapConsumer.fromSourceMap(e, r)
      ...
      BasicSourceMapConsumer.fromSourceMap =
        function SourceMapConsumer_fromSourceMap(e, r) {
          ...
          n._absoluteSources = n._sources
            .toArray()
            .map((e) => o.computeSourceURL(n.sourceRoot, e, r))
      ...
      BasicSourceMapConsumer.prototype.hasContentsOfAllSources =
        function BasicSourceMapConsumer_hasContentsOfAllSources() {
          ...
          return (
            ...
            !this.sourcesContent.some((e) => e == null)
          )
        }
      ...
      IndexedSourceMapConsumer.prototype.originalPositionFor =
        function IndexedSourceMapConsumer_originalPositionFor(e) {
          ...
          var n = i.search(r, this._sections, (e, r) => {
      ...
      IndexedSourceMapConsumer.prototype.hasContentsOfAllSources =
        function IndexedSourceMapConsumer_hasContentsOfAllSources() {
          return this._sections.every((e) =>
            e.consumer.hasContentsOfAllSources(),
          )
        }
    ...
    163: (e, r, n) => {
      ...
      SourceMapGenerator.prototype.applySourceMap =
        function SourceMapGenerator_applySourceMap(e, r, n) {
          ...
          var u = new i()
          var s = new i()
          this._mappings.unsortedForEach((r) => {
      ...
      SourceMapGenerator.prototype._generateSourcesContent =
        function SourceMapGenerator_generateSourcesContent(e, r) {
          return e.map(function (e) {
            ...
            return Object.hasOwn(this._sourcesContents, n)
    ...
    297: (e, r) => {
      ...
      r.join = join
      r.isAbsolute = (e) => e.charAt(0) === '/' || n.test(e)
