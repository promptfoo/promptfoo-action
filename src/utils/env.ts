...
// Cover all native-loader controls (including LD_AUDIT) and all git/npm
// process controls. These children inherit process.env after env-files load.
const FORBIDDEN_ENV_FILE_PREFIXES = ['DYLD_', 'GIT_', 'LD_', 'NPM_CONFIG_'];
