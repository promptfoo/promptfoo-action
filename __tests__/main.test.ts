...
describe('GitHub Action Main', () => {
  ...
  describe('run function', () => {
    ...
    test('should preserve action prompt overrides after mapped dependencies change', async () => {
      mockOctokit.paginate.mockResolvedValue([
    ...
    test('should run for conservatively watched dynamic mapped template imports', async () => {
      mockOctokit.paginate.mockResolvedValue([
    ...
    test.each(['../private/secret.txt', '/private/secret.txt'])(
      'should reject evaluated mapped prompt paths outside the workspace: %s',
      async (promptPath) => {
        mockOctokit.paginate.mockResolvedValue([
          { filename: 'shared/system.txt' },
        ]);
    ...
    test('should reject evaluated mapped prompt symlinks outside the workspace', async () => {
